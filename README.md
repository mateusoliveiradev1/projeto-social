...
## Changelog
Nota de escopo: este changelog resume alterações de documentação e mídia recentes; para o histórico completo, consulte os commits no repositório.

### Melhorias visuais e conteúdo
